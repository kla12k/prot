...
const Home = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-gray-800 to-gray-900 p-5 flex items-center justify-center" style={{ backgroundImage: 'url(https://www.originfitness.com/media/magefan_blog/Dollar_Academy_WEB-01.jpg)' }}>
      <motion.div 
        ...
        <div className="text-center">
          ...
          <Link href="/customer"> {/* Wrap the button with the Link component */}
            <motion.button 
